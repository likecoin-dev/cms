<div class="tab-pane active" id="settings">
	...
	{{ Form::open(array('route' => 'api.user.save.settings')) }}
		...
		<div class="form-group" rel="username">
			...
			{{ Form::text('username', $user->username, array('class' => 'form-control', 'placeholder' => t('placeholder.user.settings.username'), 'data-bind' => 'value: itemName, valueUpdate: "afterkeydown"')) }}
		</div>
