		...
		<div class="row">
			...
			<div class="col-xs-10 main">
				...
				<div class="breadcrumb-wrapper search">
					...
					{{\Render::searchForm('user', array('username', 'email', 'lastname', 'is_valid'))}}
							...
							<ol class="dl-list ol-list pongo-active">
								...
								@foreach ($users as $user)
									<li class="dl-item" data-id="{{$user->id}}">
										...
										@else
										<label><input type="checkbox" value="{{$user->id}}" class="pongo-checkbox"{{Tool::isChecked($user->is_valid, 1)}}><span></span></label>
										@endif
										<div class="btn-edit">
